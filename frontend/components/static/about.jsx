...
const AboutPage = () => (
  ...
  <h1>About Us</h1>
    ...
    <h4>F*** That Noise was developed in response to President Trump’s January 2017 refugee ban. While F*** That Noise welcomes visitors of all types, movements promoting the equality of all people regardless of their identity, are particularly encouraged.</h4>
    ...
    <h4>F*** That Noise is open source. If you are a developer and would like to contribute, check us out on <a href="https://github.com/flaurida/mobilize" target="_blank">
      Github
    </a> :)</h4>
  </div>
);
